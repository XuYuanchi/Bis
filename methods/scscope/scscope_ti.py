...
def RUN_MAIN():
    ...
    i=0
    data_name = ['gse', 'Deng', 'Petropoulos']
    dat_sc = pd.read_csv('data/ti/'+data_name[i]+'.csv', sep=',', header=0, index_col=0)
    ...
    path = "/home/suyanchi/project/dab/results/ti/scscope_"+data_name[i]+  ".mat"
    scio.savemat(path, {'re':imputed_val.T})
